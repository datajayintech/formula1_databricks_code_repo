...
constructor_with_ingestion_date_df = add_ingestion_date(constructor_final_df)
...
constructor_with_ingestion_date_df.write.mode("overwrite").format("delta").saveAsTable("f1_processed.constructors")
